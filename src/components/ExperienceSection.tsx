          ...
          <AnimatePresence>
            ...
            <motion.div
              ...
              className={`relative flex flex-col md:flex-row gap-8 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                ...
                className="absolute left-0 md:left-1/2 w-4 h-4 bg-blue-500 rounded-full border-4 border-[#0a0a0a] transform -translate-x-1/2 mt-6 hidden md:block z-10">
                  ...
                  <Card hoverEffect className="p-6 md:p-8 h-full group">
                    <div className="flex flex-col h-full">
                      ...
                      <motion.span
                        ...
                        className="px-3 py-1 text-xs font-medium text-blue-300 bg-blue-500/10 rounded-full border border-blue-500/20 hover:bg-blue-500/20 hover:border-blue-500/40 transition-all cursor-default">
